...
import {
  EmployeeAvailability, EmployeeDocumentType, EmployeeStatus, EntityStatus,
  Gender, MaritalStatus, ProjectTeamRole,
} from '@prisma/client';
...
export class CreateEmployeeDto {
  @ApiProperty() @Matches(/^[A-Za-z0-9][A-Za-z0-9._-]{1,49}$/) employeeCode!: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) nationalId?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) passportNumber?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) nationality?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) religion?: string;
  @ApiPropertyOptional({ enum: MaritalStatus }) @IsOptional() @IsEnum(MaritalStatus) maritalStatus?: MaritalStatus;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(10) bloodGroup?: string;
  ...
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) emergencyContactRelationship?: string;
  @ApiPropertyOptional() @IsOptional() @IsEmail() @MaxLength(320) personalEmail?: string;
  @ApiPropertyOptional() @IsOptional() @IsEmail() @MaxLength(320) companyEmail?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(2048) photoUrl?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(2048) signatureUrl?: string;
  @ApiPropertyOptional({ enum: EmployeeStatus }) @IsOptional() @IsEnum(EmployeeStatus) status?: EmployeeStatus;
  @ApiPropertyOptional({ enum: EmployeeAvailability }) @IsOptional() @IsEnum(EmployeeAvailability) availability?: EmployeeAvailability;
...
export class EmployeeQueryDto {
  ...
  @ApiPropertyOptional() @IsOptional() @Type(() => Number) @IsInt() @Min(1) @Max(200) limit = 25;
  ...
  @ApiPropertyOptional() @IsOptional() @Transform(({ value }) => value === true || value === 'true') @IsBoolean() includeDeleted = false;
}
...
export class AssignProjectDto {
  ...
  @ApiProperty({ enum: ProjectTeamRole }) @IsEnum(ProjectTeamRole) role!: ProjectTeamRole;
  @ApiProperty() @IsDateString() assignedAt!: string;
  @ApiPropertyOptional() @IsOptional() @IsDateString() unassignedAt?: string;
  @ApiPropertyOptional() @IsOptional() @Type(() => Number) @IsNumber({ maxDecimalPlaces: 2 }) @Min(0.01) @Max(100) allocationPct?: number;
  @ApiPropertyOptional() @IsOptional() @Type(() => Number) @IsNumber({ maxDecimalPlaces: 2 }) @Min(0) @Max(168) workingHours?: number;
}

export class AssignSkillDto {
  @ApiProperty() @IsUUID() skillId!: string;
  @ApiPropertyOptional() @IsOptional() @Type(() => Number) @IsInt() @Min(1) @Max(5) proficiencyLevel?: number;
  @ApiPropertyOptional() @IsOptional() @Type(() => Number) @IsNumber({ maxDecimalPlaces: 2 }) @Min(0) @Max(80) yearsExperience?: number;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(1000) notes?: string;
}

export class CreateCertificationDto {
  @ApiProperty() @IsString() @MinLength(2) @MaxLength(200) name!: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) certificationNo?: string;
  @ApiPropertyOptional() @IsOptional() @IsDateString() issueDate?: string;
  @ApiPropertyOptional() @IsOptional() @IsDateString() expiryDate?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(200) issuingAuthority?: string;
...
export class CreateEmployeeDocumentDto {
  @ApiProperty({ enum: EmployeeDocumentType }) @IsEnum(EmployeeDocumentType) documentType!: EmployeeDocumentType;
  @ApiProperty() @IsString() @MinLength(2) @MaxLength(255) title!: string;
  @ApiPropertyOptional() @IsOptional() @IsUUID() fileObjectId?: string;
  @ApiPropertyOptional() @IsOptional() @IsString() @MaxLength(100) documentNumber?: string;
